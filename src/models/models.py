...
def run_models(feats, model_list, X_train, X_test, y_train, y_test, random_state=42):
    ...
    for model_type in model_list:
        ...
        # Gradient Boosting fit model
            ...
            clf = GradientBoostingClassifier(n_estimators=170, max_depth=5, learning_rate=0.5, min_samples_leaf=3,
                                             min_samples_split=4)
        else:
    ...
    return best_model, best_model_type, best_model_predictions, pipeline
